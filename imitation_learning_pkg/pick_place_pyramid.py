...
@register_env
class PickPlacePyramid(ManipulationEnv):
    """
    ...
    def __init__(
        ...
        # task settings
        self.obj_names = ["block_1", "block_2", "block_3"]
    ...
    def reward(self, action=None):
        ...
        self._check_success()
        reward = np.sum(self.success_pyramid) # 피라미드로 쌓았는지 self.success_pyramid
    ...
    def _load_model(self):
        ...
        조작할 물체 정의.
        환경과 로봇, 물체들의 모델을 병합(merge_assets)하는 파트
        """
        super()._load_model()
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            for i, obj in enumerate(self.objects):
                ...
                enableds += [True] * len(obj_sensor_names)
    ...
    def _reset_internal(self):
        ...
        에피소드 리셋될 때 물체 어디에 둘지.
        robosuite의 UniformRandomSampler를 통해 지정된 바운더리에서 물체를 랜덤하게 스폰 가능.
        """
